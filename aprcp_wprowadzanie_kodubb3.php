...
$kodalch = str_replace(" ", "", $kodal);
$kodalc = str_replace(".", "", $kodalch);
...
//dodane - poczštek===========================================================
$dlugosc = strlen($kodalc);

$kodalc2 = $kodalc;
$czwartyZnak = substr($kodalc , 3 , 1);

if( strlen($kodalc) > 20 )
	{
		$kodalc2 = substr($kodalc , 0 , 12);
	}
elseif( strlen($kodalc) === 10 and $czwartyZnak === '-' )
	{
		$kodalc2 = substr($kodalc , 0 , 3);
		$kodalc2 = str_replace(" ", "", $kodalc2);		
		
	}
	elseif( strlen($kodalc) === 11 and $czwartyZnak !== '-' )
	{
		$kodalc2 = substr($kodalc , 0 , 4);
		$kodalc2 = str_replace(" ", "", $kodalc2);		
...
if($dlug_nr_etyk>2)
{
	...
	if($nr_etyk<>$kodalc2) //<- było $kodalc=======================================================
	{ 
		echo include "../barcodem/aprcp_z_czytnikabb_alc.php"; echo "<font size='1'>$komunikat1"; 
	}
    else  
	{ 
		mysql_connect('localhost',$uzytkownik,$haslo);
...
{											
	...
	$lokbc	 			= mysql_result($wynik5hj, 0, "lok");	
