...
function klawisze(evnt) {
 if (document.all) Key = event.keyCode; else Key = evnt.which;
  ...
  echo "
   switch (Key) {
     case 32: document.location.href='aprcp_z_czytnika.php?kod=0'; 
	 break;
     case 27: document.location.href='aprcp_z_czytnika.php?kod=0';
     break;
     case 40: document.location.href='aprcp_z_czytnika.php?kod=0';
     break
     default: document.location.href='aprcp_z_czytnika.php?kod=0';
   }"
  ?>
}
