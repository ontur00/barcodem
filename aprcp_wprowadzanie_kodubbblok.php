...
elseif($lok_z_b==="ZB"){  echo "<font size='0'>"; echo include "../barcodem/zapisz_prz_dane.php"; 
							$komunikat = "<EMBED src='tada.wav' autostart=true loop=false volume=250 hidden=true><NOEMBED><BGSOUND src='tada.wav'></NOEMBED>
							<center><B><font size='1'><FONT COLOR='#0000BB'>Pudelko zostalo zerejestrowane <FONT COLOR='#00BB00'><BR> Podaj nr błedu strefa zablokowana
...
elseif($lok_z_b==="MP"){  echo "<font size='0'>"; echo include "../barcodem/aprcp_z_czytnikabbblok.php"; 
							$komunikat = "<EMBED src='tada.wav' autostart=true loop=false volume=250 hidden=true><NOEMBED><BGSOUND src='tada.wav'></NOEMBED>
							<center><B><font size='1'><FONT COLOR='#FF0000'>Pudelko zostało przyjete z produkcji<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
		...
		<FONT COLOR='#00BB00'><BR> Podaj nr błedu strefa zablokowana ";	echo $komunikat; 
